...
f279a70 feat(llm): 实现 OpenAICompatibleLLMProvider
 ...
 src/ragnexus/adapters/llm/__init__.py          |   3 +-
 src/ragnexus/adapters/llm/openai_compatible.py | 125 ++++++
 tests/unit/test_llm_openai_compat.py           | 526 +++++++++++++++++++++++++
...
index 99d18ad..39dac1d 100644
--- a/src/ragnexus/adapters/llm/__init__.py
...
diff --git a/src/ragnexus/adapters/llm/openai_compatible.py b/src/ragnexus/adapters/llm/openai_compatible.py
new file mode 100644
index 0000000..6c187aa
--- /dev/null
+++ b/src/ragnexus/adapters/llm/openai_compatible.py
@@ -0,0 +1,125 @@
...
+        )
diff --git a/tests/unit/test_llm_openai_compat.py b/tests/unit/test_llm_openai_compat.py
new file mode 100644
index 0000000..68b1f45
--- /dev/null
+++ b/tests/unit/test_llm_openai_compat.py
@@ -0,0 +1,526 @@
